...
function forms(formSelector, modalTimerId) {
    const form = document.querySelector(formSelector),
        telegramTokenBot = '7761585018:AAHAGWUmp2XqoADI4dPfQYhiLl1Q8igPR9k',
        chatID = '1385285165'
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
function tabs(tabsSelector, tabContentsSelector, tabParentsSelecter) {
    // Tabs
    const tabs = document.querySelectorAll(tabsSelector),
        tabContents = document.querySelectorAll(tabContentsSelector),
        tabParents = document.querySelector(tabParentsSelecter);

    function hideTabContents() {
        tabContents.forEach(tabContant => {
            tabContant.classList.add('hide')
            tabContant.classList.remove('show')
        })
...
window.addEventListener('DOMContentLoaded', () => {
    ...
    ;(0,_modules_timer__WEBPACK_IMPORTED_MODULE_2__["default"])('2025-02-01', '.timer')
